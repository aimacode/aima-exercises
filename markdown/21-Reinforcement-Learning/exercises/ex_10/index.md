...
<div class="card">
    <div class="card-header p-2">
        ...
        <i id="ex21.10" class="fas fa-pen" style="color:white"></i>
        </button>
        </a>

        <a class="edit_question" id="editt_question" href="#">
        <button type="button" class="btn btn-dark float-right" title="Edit this Question" style="margin-left:10px; margin-right:10px;" onclick="edit('ex21.10');" href="#" id="buttonsolve">
        <i id="ex21.10" class="far fa-edit" style="color:white"></i>
        </button>
        </a>
...
<div id="content">
<div class="hideit" id="link">https://api.github.com/repos/sachin10101998/aima-exercises/contents/markdown/21-Reinforcement-Learning/exercises/ex_10/answers</div>
</div>
</div>
</div>