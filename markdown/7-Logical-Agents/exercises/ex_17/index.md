...
<div class="card">
    <div class="card-header p-2">
        ...
        <i id="ex7.17" class="fas fa-pen" style="color:white"></i>
        </button>
        </a>

        <a class="edit_question" id="editt_question" href="#">
        <button type="button" class="btn btn-dark float-right" title="Edit this Question" style="margin-left:10px; margin-right:10px;" onclick="edit('ex7.17');" href="#" id="buttonsolve">
        <i id="ex7.17" class="far fa-edit" style="color:white"></i>
        </button>
        </a>
