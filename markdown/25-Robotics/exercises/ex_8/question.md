...
Figure <a class="insideExerciseFigRef"  href="#FigEx2">FigEx2</a>.

1.  Consider the robot configurations shown in
    Figure <a class="insideExerciseFigRef"  href="#FigEx2">FigEx2</a>(a) through (c), ignoring the obstacle
    ...
    illustrated in Figure <a class="insideExerciseFigRef"  href="#FigEx2">FigArm1</a>(b).)<br>

2.  Draw the configuration space for each of the workspace diagrams in
    Figure <a class="insideExerciseFigRef"  href="#FigEx2">FigEx2</a>(a)–(c). (<i>Hint:</i> The
    configuration spaces share with the one shown in
    Figure <a class="insideExerciseFigRef"  href="#FigEx2">FigEx2</a>(a) the region that corresponds to
...
4.  The configuration spaces shown in
    Figure <a class="insideExerciseFigRef"  href="#FigEx2">FigEx2</a>(e)–(f) have all been generated by a
...
5.  Figure <a class="insideExerciseFigRef"  href="#FigEx2">FigEx2</a>(d) illustrates that a single planar
