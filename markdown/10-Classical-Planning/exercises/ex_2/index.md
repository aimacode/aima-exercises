...
<div class="card">
    <div class="card-header p-2">
        ...
        <i id="ex10.2" class="fas fa-pen" style="color:white"></i>
        </button>
        </a>

        <a class="edit_question" id="editt_question" href="#">
        <button type="button" class="btn btn-dark float-right" title="Edit this Question" style="margin-left:10px; margin-right:10px;" onclick="edit('ex10.2');" href="#" id="buttonsolve">
        <i id="ex10.2" class="far fa-edit" style="color:white"></i>
        </button>
        </a>
...
<div id="content">
<div class="hideit" id="link">https://api.github.com/repos/sachin10101998/aima-exercises/contents/markdown/10-Classical-Planning/exercises/ex_2/answers</div>
</div>
</div>
</div>